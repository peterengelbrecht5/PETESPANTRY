...
export function getSession() {
  ...
  return session({
    ...
    cookie: {
      ...
      maxAge: sessionTtl,
      sameSite: 'lax', // Allows for Replit auth redirects
    },
  });
}
...
export async function setupAuth(app: Express) {
  ...
  // Make sure we handle both the hostname and req.headers.host correctly
  ...
  app.get("/api/login", (req, res, next) => {
    ...
    // Use the domain from env if hostname doesn't match 
    // (happens in Replit's preview environment)
